...
INSERT INTO `auth_info` VALUES (42, 0, '船舶基础管理', '船舶基础管理', 1, '1', '', '', 1, '1', 1, '2017-11-29 11:56:44', NULL, NULL);
...
INSERT INTO `auth_info` VALUES (50, 42, '船舶列表', '商品列表', 2, '2', '/commodity/index', '', 1, '1', 1, '2017-12-07 08:47:50', NULL, NULL);
INSERT INTO `auth_info` VALUES (53, 0, '船舶采购管理', '船舶采购管理', 1, '1', '', '', 1, '1', 1, '2017-12-11 14:53:02', NULL, NULL);
INSERT INTO `auth_info` VALUES (54, 0, '船舶入库管理', '船舶入库管理', 1, '1', '', '', 1, '1', 1, '2017-12-11 14:53:20', NULL, NULL);
INSERT INTO `auth_info` VALUES (55, 0, '船舶出库管理', '船舶出库管理', 1, '1', '', '', 1, '1', 1, '2017-12-11 14:53:31', NULL, NULL);
...
INSERT INTO `auth_info` VALUES (69, 99, '仓库管理', '仓库管理', 1, '1', '', '', 1, '1', 1, '2017-12-13 14:34:48', NULL, NULL);
...
INSERT INTO `auth_info` VALUES (76, 42, '船舶分类', '商品分类', 2, '2', '/commodity/category', '', 1, '1', 1, '2017-12-14 11:16:38', NULL, NULL);
...
-- Records of brand
-- ----------------------------
INSERT INTO `brand` VALUES (1, '中联智能船舰', 'D', '别买了，不能吃...');
INSERT INTO `brand` VALUES (2, '美联智能船舰', 'M', '还可以');
INSERT INTO `brand` VALUES (3, '恒大船舰', 'H', '我家洗衣机就是海尔啊');
INSERT INTO `brand` VALUES (4, '亚洲智能船舰', 'H', '中华有为');
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '采购单' ROW_FORMAT = Dynamic;
...
INSERT INTO `buy_list` VALUES (13, 5, 1, 666, 600, '2020-12-11 15:40:43', 2, 3, 'james', '35436375757', '1');
...
INSERT INTO `buy_list` VALUES (48, 25, 1, 666, 666, '2024-07-09 10:40:19', 5, 6, '张三', '12369874563', '1');
INSERT INTO `buy_list` VALUES (49, 25, 1, 888, 888, '2024-07-09 11:06:25', 5, 6, '李四', '12341567777', '1');
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '入库单' ROW_FORMAT = Dynamic;
...
INSERT INTO `in_store` VALUES (11, 1, 1, 198, 1, '2017-12-11 14:00:42', '1');
...
INSERT INTO `in_store` VALUES (47, 1, 5, 600, 1, '2024-07-09 10:28:08', '1');
INSERT INTO `in_store` VALUES (48, 1, 25, 666, 1, '2024-07-09 10:40:30', '1');
INSERT INTO `in_store` VALUES (49, 1, 25, 888, 1, '2024-07-09 11:06:39', '1');
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '出库单' ROW_FORMAT = Dynamic;
...
INSERT INTO `out_store` VALUES (14, 25, 1, NULL, 299.00, 20, 1, '2024-07-09 10:46:04', '1');
INSERT INTO `out_store` VALUES (15, 25, 1, NULL, 299.00, 123, 1, '2024-07-09 11:07:08', '1');
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 1, 3, '辽宁舰', 'haier1001', 517, 3, 4, 5, 6, '43242342342343', '0', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2024-07-09 10:14:20', 1, 1, '/img/upload/boat.png', '2016-02-22 00:00:00', '2028-10-11 00:00:00');
INSERT INTO `product` VALUES (5, 2, 3, '辽宁舰', 'haierh11132', 757, 2, 2, 3, 6, 'weqweqweqwe', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2017-12-08 17:14:12', 1, 1, '', '2016-02-23 00:00:00', '2027-02-23 00:00:00');
INSERT INTO `product` VALUES (6, 2, 1, '辽宁舰', 'xj456', 200, 6, 2, 4, 3, '香蕉啊222', '0', 2.50, 5.50, 3.50, '2017-12-12 11:16:45', '2022-04-08 12:24:45', 1, 1, '/img/upload/banana.png', '2017-12-19 08:00:00', '2017-12-31 08:00:00');
INSERT INTO `product` VALUES (7, 1, 3, '福建舰', 'haier1002', 101, 2, 4, 5, 6, 'weqweqweqwe', '0', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2024-07-09 11:22:14', 1, 1, '/img/upload/boatIndex.png', '2016-02-22 00:00:00', '2030-09-17 00:00:00');
INSERT INTO `product` VALUES (11, 1, 3, '辽宁舰', 'haier1003', 111, 2, 4, 3, 6, '洗的很干净', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2022-04-08 15:41:02', 1, 1, '/img/upload/haier_wm.jpg', '2019-10-22 08:00:00', '2027-02-22 08:00:00');
INSERT INTO `product` VALUES (12, 1, 3, '福建舰', 'haierh11138', 222, 2, 2, 3, 6, 'weqweqweqwe', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2022-04-08 15:44:51', 1, 1, '/img/upload/h1130.png', '2016-02-22 08:00:00', '2017-02-22 08:00:00');
INSERT INTO `product` VALUES (13, 2, 1, '福建舰', 'xigua', 80, 6, 1, 2, 2, '不好吃，别买了', '0', 2.50, 20.50, 8.50, '2017-12-14 10:39:14', '2017-12-14 10:43:31', 1, 1, '', '2017-12-10 00:00:00', '2027-12-19 00:00:00');
INSERT INTO `product` VALUES (14, 2, 3, '福建舰sss', 'haierh11132a', 43, 2, 2, 2, 6, '海尔洗衣机好啊', '0', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2017-12-14 09:42:24', 1, 1, '', '2017-12-31 00:00:00', '2029-09-23 00:00:00');
INSERT INTO `product` VALUES (19, 2, 1, '福建舰', 'xg9527', 2000, 6, 2, 3, 2, '皮薄保甜', '0', 3.00, 5.00, 4.00, '2022-04-08 11:19:38', NULL, 1, NULL, '/img/upload/watermelon.png', '2022-04-09 08:00:00', '2022-04-30 08:00:00');
INSERT INTO `product` VALUES (21, 1, 1, '福建舰', 'xg123', 270, 6, 2, 4, 3, '香蕉啊', '0', 2.50, 5.50, 3.50, '2022-04-08 11:58:47', '2022-04-08 15:11:48', 1, 1, '/img/upload/banana.png', '2017-12-19 08:00:00', '2017-12-29 08:00:00');
INSERT INTO `product` VALUES (22, 1, 2, '辽宁舰', 'midea1001', 170, 7, 5, 6, 6, '很凉快', '0', 2000.00, 3999.00, 3699.00, '2022-04-08 15:39:56', '2024-07-09 10:14:17', 1, 1, '/img/upload/boat.png', '2022-03-24 00:00:00', '2034-12-20 00:00:00');
INSERT INTO `product` VALUES (23, 2, 2, '辽宁舰', 'midea1002', 980, 8, 5, 6, 6, '没有风，只有声。。。', '0', 100.00, 299.00, 249.00, '2022-04-08 15:44:22', NULL, 1, NULL, '/img/upload/midea_blower.png', '2022-04-01 08:00:00', '2038-09-15 08:00:00');
INSERT INTO `product` VALUES (24, 2, 1, '辽宁舰', 'xg124', NULL, 6, 2, 4, 3, '香蕉啊', '0', 2.50, 5.50, 3.50, '2022-04-08 11:58:47', '2022-04-08 15:11:48', 1, 1, '/img/upload/banana.png', '2017-12-19 08:00:00', '2017-12-29 08:00:00');
INSERT INTO `product` VALUES (25, 1, 1, '辽宁舰aaa', 'midea1004', 1498, 8, 5, 6, 6, '没有风，只有声。。。', '1', 1000.00, 299.00, 249.00, '2022-04-08 15:44:22', '2024-07-09 10:21:12', 1, 1, '/img/upload/boat.png', '2022-04-01 00:00:00', '2038-09-15 00:00:00');
INSERT INTO `product` VALUES (27, 1, 1, '船只', 'xg9528', 100, 6, 2, 3, 2, '皮薄保甜', '0', 3.00, 5.00, 4.00, '2022-04-08 11:19:38', '2022-04-24 15:48:59', 1, 31, '/img/upload/watermelon.png', '2022-04-09 08:00:00', '2022-06-05 08:00:00');
INSERT INTO `product` VALUES (28, 3, 1, '船只', 'xigua6', 220, 6, 1, 2, 2, '不好吃，别买了', '0', 2.50, 20.50, 8.50, '2017-12-14 10:39:14', '2022-04-24 16:02:49', 1, 1, '/img/upload/xigua2.jpeg', '2017-12-09 08:00:00', '2027-12-18 08:00:00');
INSERT INTO `product` VALUES (30, 1, 2, '福建舰', 'midea1003', 20, 8, 5, 6, 6, '没有风，只有声。。。', '0', 100.00, 299.00, 249.00, '2022-04-08 15:44:22', '2024-07-09 11:22:00', 1, 1, '/img/upload/boat.png', '2022-04-01 00:00:00', '2038-09-15 00:00:00');
...
-- ----------------------------
INSERT INTO `product_type` VALUES (1, 0, 'appliance', '军事类', '种类齐全，货源充足');
INSERT INTO `product_type` VALUES (2, 1, 'washer', '进攻型', '全是洗衣机啊~~');
INSERT INTO `product_type` VALUES (3, 1, 'televison', '防御型', '全是电视机啊~~');
INSERT INTO `product_type` VALUES (4, 0, 'fruit-vegetable', '竞速类', '全是果蔬啊~~');
INSERT INTO `product_type` VALUES (5, 4, 'vegetable', '氮气加速', '全是蔬菜啊~~');
INSERT INTO `product_type` VALUES (6, 4, 'fruit', '氢气加速', '全是水果啊~~');
INSERT INTO `product_type` VALUES (7, 1, 'air-condition', '战略型', '很凉快');
INSERT INTO `product_type` VALUES (8, 1, 'blower', '轰炸型', '也很凉快');
INSERT INTO `product_type` VALUES (11, 0, 'phone', '游玩类', '大家都机不离手');
INSERT INTO `product_type` VALUES (12, 11, 'huawei', '自驾类', '中华有为');
INSERT INTO `product_type` VALUES (13, 11, 'apple', '乘坐类', '一般般，小心被定位');
...
INSERT INTO `role` VALUES (3, '船员', '船员', 'comm_manage', '0', 1, '2019-11-14 16:49:12', 1, '2022-03-25 15:09:41');
INSERT INTO `role` VALUES (11, '水手0', '水手0', 'purchase_man', '1', 1, '2022-04-22 12:29:00', 1, '2022-04-22 13:56:29');
INSERT INTO `role` VALUES (12, '水手1', '水手1', 'in_store', '1', 1, '2022-04-22 13:56:17', NULL, NULL);
INSERT INTO `role` VALUES (13, '水手2', '水手2', 'commodity_manager', '1', 1, '2022-04-22 13:57:42', NULL, NULL);
INSERT INTO `role` VALUES (14, '水手3', '水手3', 'out_store', '1', 1, '2022-04-22 14:00:00', NULL, NULL);
INSERT INTO `role` VALUES (15, '水手4', '水手4', 'transshipment_manager', '1', 1, '2022-04-22 14:00:38', NULL, NULL);
INSERT INTO `role` VALUES (16, '水手5', '水手5', 'store_manager', '1', 1, '2022-04-24 15:12:56', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 746 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限表' ROW_FORMAT = Dynamic;
...
-- Records of supply
-- ----------------------------
INSERT INTO `supply` VALUES (1, 'zjsh', '广东工业', '广东工业', '任伟', '15287653921', '浙江省丽水市', '0');
INSERT INTO `supply` VALUES (2, 'lqlo', '江西工业', NULL, '张三', '18134532830', '浙江省龙泉市', '0');
INSERT INTO `supply` VALUES (3, 'dhgy', '湖南工业', NULL, '李四', '17493976543', '陕西省西安市', '0');
INSERT INTO `supply` VALUES (4, 'haier', '上海工业', '上海工业', '周云杰', '4006999511', '山东省青岛市', '0');
INSERT INTO `supply` VALUES (5, 'midea', '北京工业', '北京工业', '方洪波', '075726338788', '广东省佛山市', '0');
...
INSERT INTO `unit` VALUES (7, '艏', '艏');
INSERT INTO `unit` VALUES (8, '只', '只');
...
INSERT INTO `user_info` VALUES (3, 'root', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2017-11-16 19:31:49', 1, '2022-03-16 17:28:34');
INSERT INTO `user_info` VALUES (5, 'asdsjkb', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '1', 1, '2017-11-16 21:25:41', 1, '2022-03-15 14:57:44');
INSERT INTO `user_info` VALUES (6, 'dasdasf', '船员', 'c431d451c81e75ffac75a640590ed0a1', '1', '1', '1', 1, '2017-11-16 21:36:41', 1, '2017-11-21 10:45:57');
INSERT INTO `user_info` VALUES (7, 'fsdfs', '船员', 'c431d451c81e75ffac75a640590ed0a1', '1', '0', '1', 1, '2017-11-16 21:39:09', 1, '2017-11-21 10:44:35');
INSERT INTO `user_info` VALUES (10, 'root', '船员', 'c431d451c81e75ffac75a640590ed0a1', '3', '0', '1', 1, '2017-11-17 10:48:24', NULL, NULL);
INSERT INTO `user_info` VALUES (19, 'static', '船员', 'c431d451c81e75ffac75a640590ed0a1', '2', '0', '0', 1, '2017-11-29 22:10:51', NULL, NULL);
INSERT INTO `user_info` VALUES (20, 'public', '船员', 'c431d451c81e75ffac75a640590ed0a1', '2', '1', '0', 1, '2017-12-01 14:40:15', NULL, NULL);
INSERT INTO `user_info` VALUES (21, 'wk', '船员', NULL, NULL, '0', '0', 1, '2022-03-17 17:24:00', NULL, NULL);
INSERT INTO `user_info` VALUES (23, 'zhangsan', '船员', NULL, NULL, '0', '1', 1, '2022-04-08 16:18:52', NULL, NULL);
INSERT INTO `user_info` VALUES (24, 'lisi', '船员', NULL, NULL, '0', '1', 1, '2022-04-08 16:20:19', NULL, NULL);
INSERT INTO `user_info` VALUES (25, 'wangwu', '船员', NULL, NULL, '0', '1', 1, '2022-04-08 16:20:43', NULL, NULL);
INSERT INTO `user_info` VALUES (26, 'liuliu', '船员', NULL, NULL, '0', '1', 1, '2022-04-08 16:21:14', NULL, NULL);
INSERT INTO `user_info` VALUES (27, 'wzl', '船员', NULL, NULL, '1', '1', 1, '2022-04-19 17:09:13', NULL, NULL);
INSERT INTO `user_info` VALUES (28, 'caigou', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2022-04-22 13:42:35', NULL, NULL);
INSERT INTO `user_info` VALUES (29, 'ruku', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2022-04-22 13:50:25', NULL, NULL);
INSERT INTO `user_info` VALUES (30, 'chuku', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2022-04-22 13:53:20', NULL, NULL);
INSERT INTO `user_info` VALUES (31, 'shangpin', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2022-04-22 13:57:11', NULL, NULL);
INSERT INTO `user_info` VALUES (32, 'diaohuo', '船员', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2022-04-24 15:23:22', NULL, NULL);
INSERT INTO `user_info` VALUES (33, 'cangku', '船长', 'c431d451c81e75ffac75a640590ed0a1', NULL, '1', '0', 1, '2022-04-24 15:23:48', NULL, NULL);
...
INSERT INTO `user_role` VALUES (62, 16, 33);
INSERT INTO `user_role` VALUES (63, NULL, 33);
